...
def normalize_stereo(sample, mean=[0.0, 0.0, 0.0], std=[1.0, 1.0, 1.0]):
...
class StereoDataset(tud.Dataset):
    ...
    def __init__(self, data_dir, image_file, num_images=0, transform=None, load_groundtruth=False):
